...
public:
    ...
    uint32_t width() { return m_vstream_info.shape.width; }
    uint32_t height() { return m_vstream_info.shape.height; }
    uint32_t features() { return m_vstream_info.shape.features; }
    uint32_t size()
    {
