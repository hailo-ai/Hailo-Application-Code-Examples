Pose Estimation
====================
This example demonstrates pose estimation using the HailoRT C++ API.
It supports Hailo-8, Hailo-8l and Hailo-10H devices.
The application receives a HEF and images/video/camera as input, and returns the image/video with detection boxes, keypoints, and joints connections overlaid.

![output example](./pose_estimation.jpg)
...
2. Compile the project on the development machine  
    ...
    ./build.sh
    ```
    This creates the directory hierarchy build/x86_64 and compile an executable file called pose_estimation
...
Notes
----------------
- This example was built for YOLOv8_pose trained on a single class (person), To use YOLOv8_pose models      trained on multiple classes, edit yolov8pose_postprocess.cpp at line 37:
    #define NUM_CLASSES X
