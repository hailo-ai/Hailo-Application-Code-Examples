...
// Hailo includes
#include "media_library/common/math.hpp"
#include "media_library/common/hailo_objects.hpp"
#include "media_library/common/tensors.hpp"
#include "xtensor/xview.hpp"
#include "xtensor/xsort.hpp"
#include "media_library/common/nms.hpp"
#include "media_library/common/labels/coco_eighty.hpp"
...
std::vector<HailoDetection> /* `yolov8_postprocess` is a function that takes in the network output
tensors, network dimensions, strides, regression length, and number of
classes as input. It performs post-processing on the output tensors to
decode the bounding box coordinates and class probabilities. */
yolov8_postprocess(std::vector<HailoTensorPtr> &tensors,
                                                   std::vector<int> network_dims,
                                                   std::vector<int> strides,
                                                   int regression_length,
                                                   int num_classes)
