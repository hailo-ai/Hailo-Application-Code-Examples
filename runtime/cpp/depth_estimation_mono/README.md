...
This example demonstrates monocular depth estimation using the HailoRT C++ API.
It supports Hailo-8, Hailo8l and Hailo-10H devices.
The postprocessing is tailored for the SCDepthV3 architecture.
It receives a HEF file and a video as input, and produces a processed depth map video.
...
3. Run the example:
	...
	```shell script
    ./build/mono_depth_estimation -n scdepthv3.hef -i input_video.mp4
    ```
